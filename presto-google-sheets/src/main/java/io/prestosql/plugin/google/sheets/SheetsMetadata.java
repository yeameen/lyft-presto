        ...
        implements ConnectorMetadata
{
    ...
    public SheetsTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName)
    {
        ...
        Optional<SheetsTable> table = sheetsClient.getTable(tableName.getSchemaName(), tableName.getTableName());
        if (!table.isPresent()) {
            return null;
        }
    ...
    {
        return getTableMetadata(((SheetsTableHandle) table).toSchemaTableName()).get();
    }
    ...
    public Map<String, ColumnHandle> getColumnHandles(ConnectorSession session, ConnectorTableHandle tableHandle)
    {
        ...
        Optional<SheetsTable> table = sheetsClient.getTable(sheetsTableHandle.getSchemaName(), sheetsTableHandle.getTableName());
        if (!table.isPresent()) {
    ...
    private Optional<ConnectorTableMetadata> getTableMetadata(SchemaTableName tableName)
    {
        ...
        return table.isPresent() ? Optional.of(new ConnectorTableMetadata(tableName, table.get().getColumnsMetadata())) : Optional.empty();
    }

    public List<SchemaTableName> listTables(ConnectorSession session, Optional<String> schemaName)
    {
        Set<String> tables = sheetsClient.getTableNames(schemaName.get());
