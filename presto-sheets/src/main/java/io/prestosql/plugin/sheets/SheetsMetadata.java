        ...
        implements ConnectorMetadata
{
    ...
    {
        return ImmutableList.copyOf(sheetsClient.getSchemaNames());
    }
    ...
    public SheetsTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName)
    {
        ...
        SheetsTable table = sheetsClient.getTable(tableName.getSchemaName(), tableName.getTableName());
        if (table == null) {
            return null;
        }
    ...
    {
        return getTableMetadata(((SheetsTableHandle) table).toSchemaTableName());
    }
    ...
    public Map<String, ColumnHandle> getColumnHandles(ConnectorSession session, ConnectorTableHandle tableHandle)
    {
        ...
        SheetsTable table = sheetsClient.getTable(sheetsTableHandle.getSchemaName(), sheetsTableHandle.getTableName());
        if (table == null) {
    ...
    public List<SchemaTableName> listTables(ConnectorSession session, Optional<String> schemaName)
    {
        ...
        tables.stream().forEach(t -> schemaTableNames.add(new SchemaTableName(schemaName.get(), t)));
