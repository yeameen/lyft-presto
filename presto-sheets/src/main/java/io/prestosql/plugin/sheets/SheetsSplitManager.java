...
{
    private final SheetsClient exampleClient;

    @Inject
    public SheetsSplitManager(SheetsClient exampleClient)
    {
            ...
            SplitSchedulingStrategy splitSchedulingStrategy)
    {
        ...
        SheetsTable table = exampleClient.getTable(tableHandle.getSchemaName(), tableHandle.getTableName());
